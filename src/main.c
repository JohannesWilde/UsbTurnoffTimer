...
#define SEVEN_SEGMENT_MOSI_PORT_NUMBER 3
#define SEVEN_SEGMENT_MOSI_PIN_NUMBER 2
...
#define SEVEN_SEGMENT_MOSI_PIN MAKE_PIN_NAME(SEVEN_SEGMENT_MOSI_PORT_NUMBER, SEVEN_SEGMENT_MOSI_PIN_NUMBER)
...
void main()
{
    ...
    COMPILE_TIME_ASSERT((0 <= SEVEN_SEGMENT_MOSI_PIN_NUMBER) && (8 > SEVEN_SEGMENT_MOSI_PIN_NUMBER));
    ...
    COMPILE_TIME_ASSERT(3 == SEVEN_SEGMENT_MOSI_PORT_NUMBER);
    ...
    P3M0 = (0x00 /* DIO_MODE_HIGH_Z_INPUT_M0 */) |
           ...
           (DIO_MODE_OPEN_DRAIN_M0 << SEVEN_SEGMENT_MOSI_PIN_NUMBER) |
